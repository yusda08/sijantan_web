...
-- Dumping data for table sijantan.data_jembatan: ~1 rows (approximately)
...
INSERT INTO `data_jembatan` (`jembatan_id`, `nomor`, `nama`, `kecamatan`, `ruas`, `sta`, `latitude`, `longitude`, `create_at`, `update_at`) VALUES
	(10, 1, 'baru', 'Hatungun', 'saja', '2000', '-2.9347086187000193', '115.15002870947212', '2021-06-21 16:59:39', NULL);
...
-- Dumping data for table sijantan.data_jembatan_spesifikasi: ~1 rows (approximately)
...
INSERT INTO `data_jembatan_spesifikasi` (`jembatan_id`, `tahun`, `kondisi_id`, `panjang`, `lebar`, `jumlah_bentang`, `create_at`, `update_at`) VALUES
	(10, 2021, 2, 12, 12, 12, '2021-06-21 16:59:39', NULL);
...
INSERT INTO `data_jembatan_tipekondisi` (`jembatan_id`, `tipekondisi_id`, `tahun`, `tipe`, `kondisi_id`, `create_at`, `update_at`) VALUES
	(10, 1, '2021', '1', 2, '2021-06-21 16:59:39', NULL),
	(10, 2, '2021', '1', 2, '2021-06-21 16:59:39', NULL),
	(10, 3, '2021', '1', 3, '2021-06-21 16:59:39', NULL),
	(10, 4, '2021', '1', 4, '2021-06-21 16:59:39', NULL);
