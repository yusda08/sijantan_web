        ...
        <div class="col-md-12">
            <div class="card card-outline">
                <div class="card-header">
                    <h3 class="card-title">Pengaduan Jembatan</h3>
                </div>
                <div class="card-body">
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <note style="color: red; font-size: 10pt">Note Filter : Nama Jembatan dan Pengadu</note>
                        </div>
                    </div>
                    <div class="scroll">
        ...
        return `<div class="list-group mb-3">
                                    <a href="${siteUrl(`<?=$moduleUrl;?>/detail?tiket=${res.tiket_kode}`)}" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">${res.jembatan_nama}</h5>
