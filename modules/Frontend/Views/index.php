...
<section class="header bg-gray mb-3">
    <div class="position-relative overflow-hidden mb-3 text-center">
        <div class="col-md-5 mx-auto my-3 title-app ">
            ...
            <h3>Pemerintah Kabupaten Tapin - Provinsi Kalimantan Selatan<br><small>Dinas Pekerjaan Umum Dan Penataan Ruang</small></h3>
        </div>
...
<div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?= site_url('frontend/jalan') ?>" class="small-box-footer">More info <i
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3><span class="ruas-jembatan-total"></span> Titik</h3>
                                ...
                                <a href="<?= site_url('frontend/jembatan') ?>" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(async function () {
            ...
            let ttlJembatan = 0, panjangJembatan = 0;
            ttlJembatan = dataJembatan.length;
            $('.ruas-jembatan-total').text(ttlJembatan);
